...
#define PRODUCT_ID      0x4E52                  //VENDOR_ID和PRODUCT_ID组成键盘的唯一编号，和json文件设成一样，VIA设置软件靠这个编号识别
#define MANUFACTURER    'R','o','b','i','t'     //键盘厂商
#define PRODUCT         'N','R','G','B'         //键盘名称

#define MATRIX_ROWS     1       //键盘矩阵行数
#define MATRIX_COLS     1       //键盘矩阵列数
...
#define DIRECT_PINS { {31} }   //按键为引脚直连到地，从左到右为为行到列定义引脚
...
#define TAP_DANCE_COUNT  1      //复用键个数，最多5个，每个占用dataflash 6 bytes
...
#define WS2812_DI_PIN        16 //RGB灯数据引脚
#define RGB_MATRIX_LED_COUNT 15 //RGB灯数量
#define RGB_EFFECTS_PLUS        //开启6种色彩循环本地灯效，rom: 1206 bytes
#define RGB_KEY_CONTROL         //开启按键控制6种色彩循环灯效，rom: 404 bytes
#define RGB_MATRIX_ROWS      15
#define RGB_MATRIX_COLS      1

// #define ENCODER_ENABLE          //开启编码器，rom:1316 bytes
#define NUM_ENCODERS    1       //编码器个数
#define ENCODERS_PAD_A  { 32 }  //编码器A引脚
#define ENCODERS_PAD_B  { 33 }  //编码器B引脚
