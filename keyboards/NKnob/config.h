...
#define PRODUCT_ID      0x4E4B                  //VENDOR_ID和PRODUCT_ID组成键盘的唯一编号，和json文件设成一样，VIA设置软件靠这个编号识别
#define MANUFACTURER    'R','o','b','i','t'     //键盘厂商
#define PRODUCT         'N','K','n','o','b'     //键盘名称
...
#define DIRECT_PINS { {11} }   //按键为引脚直连到地，从左到右为为行到列定义引脚
...
#define WS2812_DI_PIN        14 //RGB灯数据引脚
#define RGB_MATRIX_LED_COUNT 4  //RGB灯数量
// #define RGB_EFFECTS_PLUS        //开启6种色彩循环本地灯效，rom: 1206 bytes
#define RGB_KEY_CONTROL         //开启按键控制6种色彩循环灯效，rom: 404 bytes
#define RGB_MATRIX_ROWS      2
#define RGB_MATRIX_COLS      2
